...
## Technologies used
The web application architecture is a Single-Page Application one. The frontend is developed using ReactJS, whereas the backend allows the data access through an API RESTful, developed with NodeJS and ExpressJS. The datas are storaged in an ORM database.
